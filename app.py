...
st.title("🧭Modern Data Sweeper")
st.write("Transform your files from CSV to Excel formats with built-in data cleaning and visualization!")
...
if uploaded_files:
    for file in uploaded_files:
        ...
        st.error(f"File Size:{file.size/1024}")
